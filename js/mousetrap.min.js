/*global define:false */
!function(e,t,n){function r(e,t,n){if(e.addEventListener)return void e.addEventListener(t,n,!1)
...
return t=f(r,o,t),{key:r,modifiers:o,action:t}}function h(e,n){return null!==e&&e!==t&&(e===n||h(e.parentNode,n))}function y(e){function n(e){e=e||{}
var t,n=!1
for(t in g)e[t]?n=!0:g[t]=0
n||(K=!1)}function s(e,t,n,r,i,a){var c,u,s=[],f=n.type
if(!k._callbacks[e])return[]
for("keyup"==f&&l(e)&&(t=[e]),c=0;c<k._callbacks[e].length;++c)if(u=k._callbacks[e][c],(r||!u.seq||g[u.seq]==u.level)&&f==u.action&&("keypress"==f&&!n.metaKey&&!n.ctrlKey||o(t,u.modifiers))){var p=!r&&u.combo==i,d=r&&u.seq==r&&u.level==a;(p||d)&&k._callbacks[e].splice(c,1),s.push(u)}return s}function f(e,t,n,r){k.stopCallback(t,t.target||t.srcElement,n,r)||e(t,n)===!1&&(c(t),u(t))}function p(e){"number"!=typeof e.which&&(e.which=e.keyCode)
var t=i(e)
if(t)return"keyup"==e.type&&w===t?void(w=!1):void k.handleKey(t,a(e),e)}function h(){clearTimeout(b),b=setTimeout(n,1e3)}function v(e,t,r,o){function a(t){f(r,t,e),"keyup"!==o&&(w=i(t)),setTimeout(n,10)}g[e]=0
for(var c=0;c<t.length;++c){var u=c+1===t.length,l=u?a:function(t){return function(){K=t,++g[e],h()}}(o||d(t[c+1]).action)
m(t[c],l,o,e,c)}}function m(e,t,n,r,i){k._directMap[e+":"+n]=t,e=e.replace(/\s+/g," ")
var o,a=e.split(" ")
if(a.length>1)return void v(e,a,t,n)
o=d(e,n),k._callbacks[o.key]=k._callbacks[o.key]||[],s(o.key,o.modifiers,{type:o.action},r,e,i),k._callbacks[o.key][r?"unshift":"push"]({callback:t,modifiers:o.modifiers,action:o.action,seq:r,level:i,combo:e})}var k=this
if(e=e||t,!(k instanceof y))return new y(e)
k.target=e,k._callbacks={},k._directMap={}
var b,g={},w=!1,_=!1,K=!1
k._handleKey=function(e,t,r){var i,o=s(e,t,r),a={},c=0,u=!1
for(i=0;i<o.length;++i)o[i].seq&&(c=Math.max(c,o[i].level))
for(i=0;i<o.length;++i)if(o[i].seq){if(o[i].level!=c)continue
u=!0,a[o[i].seq]=1,f(o[i].callback,r,o[i].combo,o[i].seq)}else u||f(o[i].callback,r,o[i].combo)
var p="keypress"==r.type&&_
...
y.prototype.bind=function(e,t,n){var r=this
return e=e instanceof Array?e:[e],r._bindMultiple.call(r,e,t,n),r},y.prototype.unbind=function(e,t){var n=this
